...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Employés</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Liste des Employés</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                    ...
                    <table class="table table-hover" id="example1" data-page-length='50' style=" text-align: center;">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">Nom & Prénom</th>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="label text-danger ">
                                                <div class="dot-label bg-danger ml-5 "></div>{{ $user->Status }}
                                            </span>
                                        @endif
                                    </td>
