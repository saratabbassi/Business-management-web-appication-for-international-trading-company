...
<div class="row">
        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    @can('Ajouter Categorie')

                    <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale"
                        data-toggle="modal" href="#modaldemo8">Ajouter Catégorie</a>
                        @endcan
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0">Nom du Ctaégorie</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                            data-id="{{ $x->id }}"
                                            data-categorie_name="{{ $x->categorie_name }}" data-toggle="modal"
                                        ...
                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                            data-id="{{ $x->id }}"
                                            data-categorie_name="{{ $x->categorie_name }}" data-toggle="modal"
                                            href="#modaldemo9" title="Supprimer"><i class="las la-trash"></i></a>
                                            @endcan
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Ajouter Catégorie</h6><button aria-label="Close" class="close"
                ...
                <div class="modal-body">
                    <form action="{{ route('categories.store') }}" method="post">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nom du Catégorie</label>
    ...
    <div class="modal" id="modaldemo9">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Supprimer Catégorie </h6><button aria-label="Close" class="close"
                        data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <form action="categories/destroy" method="post">
                    ...
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <p>voulez-vous supprimer la catégorie ?</p><br>
                        <input type="hidden" name="id" id="id" value="">
